    ...
    const platforms = [
        {
            ...
            placeholder: 'Choose a tool below to get started!',
            heading: 'All-in-One Social Downloader',
            subheading: 'The fastest and most reliable way to download videos from your favorite platforms and generate AI captions.'
        },
        {
            id: 'facebook',
            name: 'Facebook',
            ...
            subheading: 'Download Facebook videos in HD quality instantly – fast, free, and secure.'
        },
        {
            id: 'instagram',
            name: 'Instagram',
            ...
            subheading: 'Download Instagram reels, videos, and posts in one click.'
        },
        {
            id: 'youtube',
            name: 'YouTube',
            ...
            subheading: 'Download YouTube videos in multiple resolutions easily.'
        },
        {
            id: 'captions',
            name: 'AI Captions',
            ...
            placeholder: 'Choose a tool below!',
            heading: 'AI Caption Generator',
            subheading: 'Generate engaging captions for social media posts in seconds.'
        },
    ];
...
21:                   ${selectedPlatform === platform.id ? 'ring-4 ring-offset-2 ring-blue-400 shadow-2xl' : 'hover:shadow-2xl'}`}
                    ...
                    {/* URL Input Area and Download Button - Only show if not on Home page */}
                    {selectedPlatform !== 'home' && (
                        <>
                          ...
                          shadow-xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-100 border-blue-200 focus:border-blue-500 bg-white`}
                                    />
                                    {/* Paste Icon */}
                                    <button
                                        onClick={onPaste}
                          ...
                          transition-all duration-200 text-blue-600 hover:bg-blue-50`}
                                    >
                                        <svg
                                            className="w-6 h-6"
                                            fill="none"
                        ...
                        flex items-center justify-center gap-3 text-lg ${!url.trim() || loading
